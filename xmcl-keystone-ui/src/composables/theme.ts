...
export function getDefaultTheme(): UIThemeDataV1 {
  return {
    ...
    colors: {
      lightAppBarColor: '#f3f4f6CC',
      lightSideBarColor: '#ffffff99',
      darkAppBarColor: '#09090b99',
      darkSideBarColor: '#09090b80',
      darkPrimaryColor: '#8b5cf6',
      darkBackground: '#09090bB3',
      darkInfoColor: '#3b82f6',
      darkErrorColor: '#ef4444',
      darkWarningColor: '#f59e0b',
      darkSuccessColor: '#10b981',
      darkAccentColor: '#c4b5fd',
      darkCardColor: '#18181b99',
      lightPrimaryColor: '#6366f1',
      lightBackground: '#f8fafc',
      lightInfoColor: '#3b82f6',
      lightErrorColor: '#ef4444',
      lightWarningColor: '#f59e0b',
      lightSuccessColor: '#10b981',
      lightAccentColor: '#818cf8',
      lightCardColor: '#ffffffB3',
    },
