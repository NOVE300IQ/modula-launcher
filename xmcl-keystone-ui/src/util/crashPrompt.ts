...
若是mod造成的崩溃，你应当通过日志分析出哪些mod可能造成这些错误，并提示我。注意我正在是用 Modula Launcher，关于修复崩溃的建议（如下载 Mod）应当在 Modula Launcher 里进行。

如果实在分析不出具体原因，请告知我应当联系开发者。官方 Discord：https://discord.gg/gyjG6NjYcR
...
For Java issues or missing vanilla game libraries, you should provide direct reminders. Please note that I am using Modula Launcher, and any suggestions for fixing crashes (such as downloading mods) should be done within Modula Launcher.
...
If the specific cause cannot be determined, please inform me that I should contact the developers. Join discord: https://discord.gg/gyjG6NjYcR
