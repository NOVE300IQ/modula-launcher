<template>
  ...
  >
    ...
    <v-card
      ...
      style="width: 100%"
      to="https://github.com/NOVE300IQ/modula-launcher/releases"
      target="browser"
      push
    >
...
const openOfficialWebsite = () => {
  window.open('https://www.modulamc.in/', 'browser')
}
const openGithub = () => {
  window.open('https://github.com/NOVE300IQ/modula-launcher/releases', 'browser')
}
</script>
