<template>
  <div class="relative z-10 w-full h-full min-h-[500px]">
    ...
    >
      ...
      >
        <HomeNewsCarousel
          v-if="isType(item.i, CardType.News)"
        />
        <HomeModCard
          v-else-if="isType(item.i, CardType.Mod)"
...
import { ref, onMounted, computed, provide, reactive, nextTick, watch } from 'vue'
...
const layouts = useLocalStorageCache('cardsLayout', () => ({
  md: [
    { x: 0, y: 0, w: 6, h: 9, minW: 4, minH: 4, i: rawType(CardType.News) },
    { x: 6, y: 0, w: 3, h: 9, minW: 2, minH: 4, i: rawType(CardType.Mod) },
    { x: 9, y: 0, w: 3, h: 9, minW: 2, minH: 4, i: rawType(CardType.ResourcePack) },
    { x: 0, y: 9, w: 3, h: 4, minW: 2, minH: 4, i: rawType(CardType.Save) },
    { x: 3, y: 9, w: 3, h: 4, minW: 2, minH: 4, i: rawType(CardType.ShaderPack) },
    { x: 6, y: 9, w: 6, h: 5, minW: 3, minH: 4, i: rawType(CardType.Screenshots) },
  ],
  lg: [
    { x: 0, y: 0, w: 6, h: 9, minW: 4, minH: 4, i: rawType(CardType.News) },
    { x: 6, y: 0, w: 3, h: 9, minW: 2, minH: 4, i: rawType(CardType.Mod) },
  ...
  sm: [
    { x: 0, y: 0, w: 6, h: 8, minW: 4, minH: 4, i: rawType(CardType.News) },
    { x: 0, y: 8, w: 3, h: 6, minW: 2, minH: 4, i: rawType(CardType.Mod) },
    { x: 3, y: 8, w: 3, h: 6, minW: 2, minH: 4, i: rawType(CardType.ResourcePack) },
    { x: 0, y: 14, w: 3, h: 4, minW: 2, minH: 4, i: rawType(CardType.Save) },
    { x: 3, y: 14, w: 3, h: 4, minW: 2, minH: 4, i: rawType(CardType.ShaderPack) },
  ],
  xs: [
    { x: 0, y: 0, w: 4, h: 8, minW: 4, minH: 4, i: rawType(CardType.News) },
    { x: 0, y: 8, w: 2, h: 6, minW: 2, minH: 4, i: rawType(CardType.Mod) },
    { x: 2, y: 8, w: 2, h: 6, minW: 2, minH: 4, i: rawType(CardType.ResourcePack) },
  ],
}), JSON.stringify, JSON.parse)

// Force current layout from cache or default
const layout = ref(layouts.value.md)

onMounted(() => {
  if (layout.value.length === 0) {
    layout.value = layouts.value.md
  }
})
