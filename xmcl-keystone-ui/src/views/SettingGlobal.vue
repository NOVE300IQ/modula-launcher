  ...
  <div class="flex flex-col gap-4">
    ...
    <SettingCard :title="t('setting.quickLaunchSettings')" icon="flash_on">
      ...
      <SettingItemCheckbox :value="hideLauncher" @input="hideLauncher = $event" :title="t('instanceSetting.hideLauncher')"
        :description="t('instanceSetting.hideLauncherDescription')" />
      <v-divider class="my-2" />
      ...
      <v-divider class="my-2" />
      <SettingItemCheckbox :value="optimizeJVM" @input="optimizeJVM = $event" :title="t('instanceSetting.optimizeJVM')"
        :description="t('instanceSetting.optimizeJVMDescription')" color="amber" />
    </SettingCard>
...
const optimizeJVM = ref(globalOptimizeJVM.value)
...
onMounted(() => {
  ...
  optimizeJVM.value = globalOptimizeJVM.value
})
...
function save() {
  setGlobalSettings({
    ...
    globalOptimizeJVM: optimizeJVM.value,
  })
}
