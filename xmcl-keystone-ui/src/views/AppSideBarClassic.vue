<template>
  <v-navigation-drawer
    ...
    :style="{ 'backdrop-filter': `blur(${blurSidebar}px)`, 'border-right': '1px solid rgba(255, 255, 255, 0.1)', 'box-shadow': '2px 0 16px rgba(0, 0, 0, 0.15)' }"
  >
    <v-list
      nav
      dense
  ...
  <div
    ...
    :style="{ 'backdrop-filter': `blur(${blurSidebar}px)`, backgroundColor: sideBarColor, 'border': '1px solid rgba(255, 255, 255, 0.1)', 'box-shadow': '0 4px 16px rgba(0, 0, 0, 0.15)' }"
  >
