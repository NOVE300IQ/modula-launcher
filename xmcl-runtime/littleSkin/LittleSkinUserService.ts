...
export class LittleSkinUserService extends AbstractService implements ILittleSkinUserService {
  ...
  async authenticate(): Promise<void> {
    ...
    const url = `https://littleskin.cn/oauth/authorize?client_id=393&redirect_uri=http://localhost:${port}/littleskin&response_type=code&scope`
    ...
    body.append('redirect_uri', `http://localhost:${port}/littleskin`)
