<p align="center">
  <a href="https://modula.teampixelbuff.com" target="_blank">
    <img alt="Logo" width="100" src="https://raw.githubusercontent.com/NOVE300IQ/modula-launcher/master/xmcl-electron-app/icons/dark@256x256.png">
  </a>
</p>

<p align="center">
  <a href="https://github.com/NOVE300IQ/modula-launcher">
    <img src="https://github.com/NOVE300IQ/modula-launcher/workflows/Build/badge.svg" alt="Build">
  </a>
  <a href="https://github.com/NOVE300IQ/modula-launcher/blob/master/LICENSE">
    <img src="https://img.shields.io/npm/l/@xmcl/core.svg" alt="License">
  </a>
  <br>
  <a href="https://discord.gg/gyjG6NjYcR">
    <img src="https://discord.com/api/guilds/405213567118213121/widget.png" alt="Discord">
  </a>
</p>

Visit the [official site](https://modula.teampixelbuff.com) to download the app!

If you have winget, you can use winget to install
  
```bash
winget install Modula.Launcher
```

HomeBrew installation also available (experimental)

```bash
brew tap teampixelbuff/modula
brew install --cask teampixelbuff/modula/modula
```
